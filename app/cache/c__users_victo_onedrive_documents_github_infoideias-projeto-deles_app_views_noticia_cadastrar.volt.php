...
<div id="cadastro_ticket" class="row">
    <div class="col-md-12">
        <div class="panel panel-default">
            ...
            <?= $this->tag->form(['noticias/salvar', 'method' => 'post', 'enctype' => 'multipart/form-data', 'name' => 'cadastrar', 'id' => 'formulario-cadastro']) ?>
                ...
                <div class="col-md-12" id="conteudo">
                    ...
                    <div class="row" style="text-align:right;">
                        <div id="buttons-cadastro" class="col-md-12">
                            ...
                            <?= $this->tag->submitButton(['Gravar', 'class' => 'btn btn-primary', 'id' => 'envia']) ?>
                        </div>
                    </div>
                </div>
            </div>
